...
import { CardHero, Link } from '@cannabis/core';
import { PlotHero as PlotHeroIcon } from '@cannabis/icons';
      ...
      <Grid xs={12} md={6} lg={4} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              {
                'Plots are allocated space on your hard drive used to farm and earn Cannabis. '
              }
              <Link
                target="_blank"
