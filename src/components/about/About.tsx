...
import icon from '../../assets/img/cannabis_circle.svg';
...
const url = 'https://cannabischain.net';
  ...
  return (
    <html>
      ...
      <body>
        ...
        <Spacer />
        <div className="copyright">Copyright (c) 2021 Cannabis Network</div>
        <Spacer />
        <VersionsTable>
          {versions?.electron && (
            <tr>
        ...
        <BugReport
          href="https://github.com/CannabisChain/cannabis-blockchain/issues"
          target="_blank"
        >
          Report an issue
        </BugReport>
