...
import { Card, CopyToClipboard, Flex, Table } from '@cannabis/core';
import type { Row } from '../core/components/Table/Table';
import {
  mojo_to_cannabis_string,
  ...
  },
  {
    field: (row: Row) =>
      type === WalletType.COLOURED_COIN
        ...
        : mojo_to_cannabis_string(row.amount),
    title: <Trans>Amount</Trans>,
  },
  {
    field: (row: Row) => mojo_to_cannabis_string(row.fee_amount),
