...
describe('units', () => {
  describe('#getUnit', () => {
    it('gets unit of cannabis', () => {
      const result = units.getUnit('cannabis');
    ...
    it('supports uppercase characters', () => {
      const result = units.getUnit('CANSCOIN');

      expect(result).toBe(1);
    });
    it('gets unit of cannabis using alias', () => {
  ...
  describe('#getDisplay', () => {
    it('gets display of cannabis', () => {
      const result = units.getDisplay('cannabis');
  ...
  describe('#setUnit', () => {
    ...
    it('modifies an existing unit', () => {
      units.setUnit('cannabis', 9);

      const result = units.getUnit('cannabis');

      expect(result).toEqual(9);

      units.setUnit('cannabis', 1);
    });
  });
  describe('#setDisplay', () => {
